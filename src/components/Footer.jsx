...
<footer className="footer" id="contact">
    ...
    <form className="footer-form" action="mailto:amaryllispittin@gmail.com" method="post" encType="text/plain">
        ...
        <input type="text" id="name" name="name" placeholder="Nom..." required aria-label="Nom" />
        
        <label htmlFor="email">E-mail</label>
        <input type="email" id="email" name="email" placeholder="Entrez votre adresse e-mail..." required aria-label="E-mail" />
        
        <label htmlFor="but-select">Objet</label>
        <select name="but" id="but-select" required aria-label="Objet">
        ...
        <textarea id="message" name="message" rows="5" cols="33" placeholder="Entrez votre message..." required aria-label="Message"></textarea>
        
        <input className="input-submit" type="submit" value="Envoyer" aria-label="Envoyer" />
    </form>
